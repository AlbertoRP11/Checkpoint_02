...
namespace CP2.Application.Dtos
{
    ...
    internal class VendedorDtoValidation : AbstractValidator<VendedorDto>
    {
        public VendedorDtoValidation()
        {
            ...
            RuleFor(x => x.ComissaoPercentual).InclusiveBetween(0, 100).WithMessage("O percentual de comissão deve estar entre 0 e 100.");
            RuleFor(x => x.MetaMensal).GreaterThan(0).WithMessage("A meta mensal deve ser maior que zero.");
        }
    }
}
